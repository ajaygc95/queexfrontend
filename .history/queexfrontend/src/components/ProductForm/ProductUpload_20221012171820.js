...
function ProductUpload() {
  ...
  const inputs = [
    { id: 1, name: "upc", type: "text", placeholder=, label: "upc" },
    { id: 2, name: "name", type: "text", placeholder, label: "name" },
    { id: 3, name: "upc", type: "text", placeholder, label: "upc" },
    { id: 4, name: "upc", type: "text", placeholder, label: "upc" },
    { id: 5, name: "upc", type: "text", placeholder, label: "upc" },
    { id: 6, name: "upc", type: "text", placeholder, label: "upc" },
  ];
